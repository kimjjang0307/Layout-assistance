      ...
      <div className="text-center max-w-2xl px-6 py-10 bg-black/30 rounded-2xl shadow-2xl border border-gray-700/50 backdrop-blur-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xl rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 flex items-center justify-center mx-auto gap-3"
            aria-label="마스터 모드로 시작"
          >
            <span className="animate-bounce-y-slow">마스터 모드로 시작</span>
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
          </button>
          <button
            onClick={() => onSelectMode('guest')}
            className="px-8 py-4 bg-neutral-600 hover:bg-neutral-700 text-white font-bold text-xl rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-neutral-500 focus:ring-opacity-50 flex items-center justify-center mx-auto gap-3"
            aria-label="게스트 모드로 시작"
          >
            <span>게스트 모드로 시작</span>
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
          </button>
        </div>
      </div>
